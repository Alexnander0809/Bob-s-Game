...
<html lang="es">
    <head>
        ...
        <title>Detalles del pago - Bob's Game</title>
    </head>
    <body>
        <div class="gridContainer">
            <ul class="topLinks"> 
                <li>Detalles del pago</li>
                <a href="../confirmación/confirmacion.php"><li>Confirmación</li></a>
            </ul>
            ...
            <form action="#" id="paymentForm">
                ...
                <div class="inputCon" id="name" data-top="Nombre de la tarjeta">
                <input type="text" placeholder="Andrea Rodriguez"/>
                </div>
                <div class="inputCon" id="cardNum" data-top="Número de la tarjeta" title = "type in the card number without spaces">
